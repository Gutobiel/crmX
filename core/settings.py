...
SECRET_KEY = 'django-insecure-gujysqr8qm1el(xjq%vasfs8mvdt$ghcwn@hy1w+3sntk=+wn1'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'frontend.context_processors.workspace_context',
            ],
        },
    },
]
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Bem-vindo ao CRM ArcX",
    "copyright": "ARCX Soluções Inteligente - 2025",
