...
import { workspacesApi } from '/static/js/api/index.js';

class NewWorkspaceForm {
    constructor() {
        this.form = document.getElementById('newWorkspaceForm');
        this.nameInput = document.getElementById('workspace-name');
        this.submitButton = document.getElementById('saveWorkspaceBtn');
    ...
    async handleSubmit(e) {
        ...
        try {
            const response = await workspacesApi.create({ nome });
            
            // Continuar criação da pasta de trabalho
